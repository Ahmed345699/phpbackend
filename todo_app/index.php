...
<div class="container">
    <div class="row">
        <div class="col-8 mx-auto">
            ...
            <form action="handelers/stor_task.php" method="POST" class="form border p-2 my-5">
        ...
        <div class="col-12">
            <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <td>
                        <a onclick="return confirm('هل انت متاكد من المسح?')"  href="handelers/delete_task.php?id=<?= $row['id'] ;?>" class="btn btn-danger"><i class="fa-solid fa-trash-can"></i> </a>
