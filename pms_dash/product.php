                                                ...
                                                <table id="example3" class="display table" style="min-width: 845px">
                                                    ...
                                                    <?php foreach ($products as $product):?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="d-flex">
                                                                    <a href="edit_product.php?id=<?= $product['id']; ?>" class="btn btn-primary shadow btn-xs sharp me-1"><i class="fas fa-pencil-alt"></i></a>
                                                                    <a onclick="return confirm('هل انت متاكد من المسح?')"  href="Controllers/ProductController.php?id=<?= $product['id'] ;?>" class="btn btn-danger shadow btn-xs sharp"><i class="fa fa-trash"></i></a>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    <?php endforeach; ?>
