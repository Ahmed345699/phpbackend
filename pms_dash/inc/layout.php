...
<head>
    ...
    <link href="public/vendor/swiper/css/swiper-bundle.min.css" rel="stylesheet">
    <link href="public/vendor/swiper/css/swiper-bundle.min.css" rel="stylesheet">
    ...
    <!-- tagify-css -->
    <link href="public/vendor/tagify/dist/tagify.css" rel="stylesheet">
...
<!--                                                <div class="timeline-panel">-->
<!--                                                    <div class="media me-2">-->
<!--                                                        <img alt="image" width="50" src="ipublic/mages/avatar/1.jpg">-->
<!--                                                    </div>-->
<!--                                                    <div class="media-body">-->
<!--                                                        <h6 class="mb-1">Dr sultads Send you Photo</h6>-->
<!--                                                        <small class="d-block">29 July 2020 - 02:26 PM</small>-->
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end" style="">
                                        <div class="card border-0 mb-0">
                                            <div class="card-header py-2">
                                                <div class="products">
                                                    <img src="public/images/user.jpg" class="avatar avatar-md" alt="">
                                                    <div>
        ...
        <div class="deznav-scroll">
            <ul class="metismenu" id="menu">
                ...
                <li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
                    ...
                    <ul aria-expanded="false">
                        <li><a href="category.php">Category Detail</a></li>
...
<script src="public/vendor/draggable/draggable.js"></script>
<script src="public/vendor/swiper/js/swiper-bundle.min.js"></script>


<!-- tagify -->
<script src="public/vendor/tagify/dist/tagify.js"></script>
...
<script src="public/vendor/jqvmap/js/jquery.vmap.world.js"></script>
