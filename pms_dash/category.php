                                            ...
                                            <div class="table-responsive">
                                                <table id="example3" class="display table" style="min-width: 845px">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="d-flex">
                                                                <a href="edit_category.php?id=<?= $category['id']; ?>" class="btn btn-primary shadow btn-xs sharp me-1"><i class="fas fa-pencil-alt"></i></a>
                                                                <a onclick="return confirm('هل انت متاكد من المسح?')"  href="Controllers/categoryController.php?id=<?= $category['id'] ;?>" class="btn btn-danger shadow btn-xs sharp"><i class="fa fa-trash"></i></a>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <?php endforeach; ?>
